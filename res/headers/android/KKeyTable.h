/**
 * Kanji rendering and I/O engine - portable keycode definitions
 *
 * (c) 2010
 */

#ifndef  _KANJI_KKEYTABLE_H
#define  _KANJI_KKEYTABLE_H
...
enum EKeyboardLayout {
   K_VK_LEFT = 0, K_VK_UP, K_VK_DOWN, K_VK_RIGHT,
   ...
   K_VK_L_ALT, K_VK_R_ALT,
   
   K_VK_ERROR,
};

#endif   /* _KANJI_KKEYTABLE_H */
