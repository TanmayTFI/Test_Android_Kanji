...
#ifndef DQFYLH_L7_S2_HOBROKENLEFTHAND_DEF
#define DQFYLH_L7_S2_HOBROKENLEFTHAND_DEF
...
class L7_S2_HOBrokenLeftHand : public HiddenObjectSystem, public HandHOControllerDelegate
{
	int _sceneState;
